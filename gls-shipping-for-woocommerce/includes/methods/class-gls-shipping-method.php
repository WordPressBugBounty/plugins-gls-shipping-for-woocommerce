...
max_weight|cost',
					...
					'auto_complete_order' => array(
						'title'       => __('Auto Complete Order', 'gls-shipping-for-woocommerce'),
						'type'        => 'checkbox',
						'label'       => __('Automatically mark order as Completed after label is printed', 'gls-shipping-for-woocommerce'),
						'description' => __('When enabled, the order status will be set to Completed after a GLS shipping label is successfully generated.', 'gls-shipping-for-woocommerce'),
						'desc_tip'    => true,
						'default'     => 'no',
					),
